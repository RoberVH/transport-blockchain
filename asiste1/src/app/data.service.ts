...
export class DataService<Type> {
    ...
    constructor(private http: Http) {
        //this.actionUrl = '/api/';
        this.actionUrl = 'http://effortium.com:3000/api/';
    ...
    public getAll(ns: string): Observable<Type[]> {
        ...
        console.log('Enviando esto en el getAll: ', this.actionUrl + ns);
    ...
    public add(ns: string, asset: Type): Observable<Type> {
        ...
        console.log('Enviando esto en el post: ', this.actionUrl + ns);
